                ...
                <div className="card2">
                    <form className="form" >
                        ...
                        <div className="btn">
                            ...
                            <button  className="button2" onClick={onOpenRegister}>Sign Up</button>
                        </div>
